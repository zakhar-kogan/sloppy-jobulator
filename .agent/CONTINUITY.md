...
Now: E2/H2/public increments plus F2 trust-policy fallback hardening and L1 live cockpit rebaseline are validated; H2 queue facets + quick-filter chips are shipped, and Phase A 80/20 trust-policy surface freeze is in place.
