...
28. For staged simplification, enforce reduced behavior at admin/API boundaries first (normalize or ignore advanced payload fields) before deleting deep internals.
