...
- `EP-2026-02-12__env-bindings-e2-h2l1` — `Status:ACTIVE` — `Created:2026-02-12` — `Updated:2026-02-12` — `Path:.agent/execplans/active/EP-2026-02-12__env-bindings-e2-h2l1.md` — `Owner:Codex` — `Summary:Wire env-bound observability/deploy baseline and ship incremental E2 redirect semantics plus H2/L1 cockpit breadth expansions.`
